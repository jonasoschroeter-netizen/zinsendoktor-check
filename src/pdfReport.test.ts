...
describe("customer PDF report", () => {
  it("generates a printable customer report with escaped metadata", () => {
    ...
    expect(html).not.toContain("Beratername optional");
    expect(html).not.toContain("Notiz für den Bericht optional");
    ...
    expect(html).not.toContain("Max &lt;Kunde&gt;");
    expect(html).not.toContain("Berater &amp; Partner");
